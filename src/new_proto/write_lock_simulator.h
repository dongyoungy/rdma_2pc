#ifndef RDMA_PROTO_WRITELOCKSIMULATOR_H
#define RDMA_PROTO_WRITELOCKSIMULATOR_H
...
class WriteLockSimulator : public LockSimulator {
  public:
    WriteLockSimulator(LockManager* manager, uint32_t id, uint32_t home_id, int workload_type,
