#ifndef RDMA_PROTO_READLOCKSIMULATOR_H
#define RDMA_PROTO_READLOCKSIMULATOR_H
...
class ReadLockSimulator : public LockSimulator {
  public:
    ReadLockSimulator(LockManager* manager, uint32_t id, uint32_t home_id, int workload_type,
