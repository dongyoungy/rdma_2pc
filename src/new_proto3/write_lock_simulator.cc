#include "write_lock_simulator.h"

namespace rdma { namespace proto {

WriteLockSimulator::WriteLockSimulator(LockManager* manager, uint32_t id, uint32_t home_id,
...
void WriteLockSimulator::StartLockRequests() {
...
void WriteLockSimulator::CreateLockRequests() {
...
void WriteLockSimulator::SubmitLockRequest() {
...
void WriteLockSimulator::SubmitUnlockRequest() {
