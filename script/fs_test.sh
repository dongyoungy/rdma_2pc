                          ...
                          do
                            ...
                            do
                              ...
                              #-m "cn004 cn005 cn006 cn008 cn010 cn012 cn013 cn014 cn015 cn016 cn017 cn018 cn019 cn020 cn021 cn022 cn023 cn024 cn025 cn026 cn027 cn028 cn029 cn030 cn032 cn033 cn034 cn035 cn036 cn037 cn038 cn039 cn040" \
                                ...
                                -m "cn002 cn004 cn006 cn007 cn008 cn009 cn010 cn011 cn012 cn013 cn016 cn017 cn018 cn019 cn020 cn021 cn022 cn023 cn025 cn026 cn027 cn028 cn030 cn032 cn033 cn034 cn035 cn036 cn038 cn040" \
                                -eo /gpfs/gpfs0/groups/mozafari/dyoon/work/lsf_log/rdma_dist_lock/fs-$lock_method_str-$workload_str-$s_e_str-$e_s_str-$e_e_str-fr$num_retry-pr$num_retry-st$sleep_time-tt$think_time-bmin$min_backoff-bmax$max_backoff-nn$num_node-u$num_user-lo$num_lock_object-tx$num_tx-rq$num_request_per_tx-simultx$simulate_tx_delay-$simulate_tx_delay_min-$simulate_tx_delay_max.e \
                                -oo /gpfs/gpfs0/groups/mozafari/dyoon/work/lsf_log/rdma_dist_lock/fs-$lock_method_str-$workload_str-$s_e_str-$e_s_str-$e_e_str-fr$num_retry-pr$num_retry-st$sleep_time-tt$think_time-bmin$min_backoff-bmax$max_backoff-nn$num_node-u$num_user-lo$num_lock_object-tx$num_tx-rq$num_request_per_tx-simultx$simulate_tx_delay-$simulate_tx_delay_min-$simulate_tx_delay_max.o -q normal \
                                "sh fs_test.lsf $num_lock_object $workload_type $num_tx $num_request_per_tx $num_user $lock_method $s_e_rule $e_s_rule $e_e_rule $num_retry $num_retry $sleep_time $think_time $simulate_tx_delay $simulate_tx_delay_min $simulate_tx_delay_max $min_backoff $max_backoff $rand_seed"
                          ...
                          do
                            ...
                            do
                              ...
                              #-m "cn004 cn005 cn006 cn008 cn010 cn012 cn013 cn014 cn015 cn016 cn017 cn018 cn019 cn020 cn021 cn022 cn023 cn024 cn025 cn026 cn027 cn028 cn029 cn030 cn032 cn033 cn034 cn035 cn036 cn037 cn038 cn039 cn040" \
                                ...
                                bsub -n $num_node -a openmpi -W $wall_time \
                                -R "span[ptile=1] affinity[core(8)]" -R rusage[mem=4096] -J local \
                                -m "cn002 cn004 cn006 cn007 cn008 cn009 cn010 cn011 cn012 cn013 cn016 cn014 cn015 cn017 cn018 cn019 cn020 cn021 cn022 cn025 cn026 cn027 cn028 cn030 cn032 cn033 cn034 cn035 cn036 cn037 cn038 cn040" \
                                -eo /gpfs/gpfs0/groups/mozafari/dyoon/work/lsf_log/rdma_dist_lock/fs-$lock_method_str-$workload_str-$s_e_str-$e_s_str-$e_e_str-fr$num_retry-pr$num_retry-st$sleep_time-tt$think_time-bmin$min_backoff-bmax$max_backoff-nn$num_node-u$num_user-lo$num_lock_object-tx$num_tx-rq$num_request_per_tx-simultx$simulate_tx_delay-$simulate_tx_delay_min-$simulate_tx_delay_max.e \
                                -oo /gpfs/gpfs0/groups/mozafari/dyoon/work/lsf_log/rdma_dist_lock/fs-$lock_method_str-$workload_str-$s_e_str-$e_s_str-$e_e_str-fr$num_retry-pr$num_retry-st$sleep_time-tt$think_time-bmin$min_backoff-bmax$max_backoff-nn$num_node-u$num_user-lo$num_lock_object-tx$num_tx-rq$num_request_per_tx-simultx$simulate_tx_delay-$simulate_tx_delay_min-$simulate_tx_delay_max.o -q normal \
                                "sh fs_test.lsf $num_lock_object $workload_type $num_tx $num_request_per_tx $num_user $lock_method $s_e_rule $e_s_rule $e_e_rule $num_retry $num_retry $sleep_time $think_time $simulate_tx_delay $simulate_tx_delay_min $simulate_tx_delay_max $min_backoff $max_backoff $rand_seed"
                              num_jobs=`bjobs 2>&1 | wc -l`
                          ...
                          do
                            ...
                            do
                              ...
                              #-m "cn004 cn005 cn006 cn008 cn010 cn012 cn013 cn014 cn015 cn016 cn017 cn018 cn019 cn020 cn021 cn022 cn023 cn024 cn025 cn026 cn027 cn028 cn029 cn030 cn032 cn033 cn034 cn035 cn036 cn037 cn038 cn039 cn040" \
                                ...
                                bsub -n $num_node -a openmpi -W $wall_time \
                                -R "span[ptile=1] affinity[core(8)]" -R rusage[mem=4096] -J local \
                                -m "cn002 cn004 cn006 cn007 cn008 cn009 cn010 cn011 cn012 cn013 cn014 cn015 cn016 cn017 cn018 cn019 cn020 cn021 cn022 cn025 cn026 cn027 cn028 cn030 cn032 cn033 cn034 cn035 cn036 cn038 cn040" \
                                -eo /gpfs/gpfs0/groups/mozafari/dyoon/work/lsf_log/rdma_dist_lock/fs-$lock_method_str-$workload_str-$s_e_str-$e_s_str-$e_e_str-fr$num_retry-pr$num_retry-st$sleep_time-tt$think_time-bmin$min_backoff-bmax$max_backoff-nn$num_node-u$num_user-lo$num_lock_object-tx$num_tx-rq$num_request_per_tx-simultx$simulate_tx_delay-$simulate_tx_delay_min-$simulate_tx_delay_max.e \
                                -oo /gpfs/gpfs0/groups/mozafari/dyoon/work/lsf_log/rdma_dist_lock/fs-$lock_method_str-$workload_str-$s_e_str-$e_s_str-$e_e_str-fr$num_retry-pr$num_retry-st$sleep_time-tt$think_time-bmin$min_backoff-bmax$max_backoff-nn$num_node-u$num_user-lo$num_lock_object-tx$num_tx-rq$num_request_per_tx-simultx$simulate_tx_delay-$simulate_tx_delay_min-$simulate_tx_delay_max.o -q normal \
                                "sh fs_test.lsf $num_lock_object $workload_type $num_tx $num_request_per_tx $num_user $lock_method $s_e_rule $e_s_rule $e_e_rule $num_retry $num_retry $sleep_time $think_time $simulate_tx_delay $simulate_tx_delay_min $simulate_tx_delay_max $min_backoff $max_backoff $rand_seed"
                              num_jobs=`bjobs 2>&1 | wc -l`
